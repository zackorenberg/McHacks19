...
class DynamicMplCanvas(mplCanvas):
    ...
    def compute_initial_figure(self):
        ...
        self.xlim = self.axes.set_xlim((np.min(X),np.max(X)))
        self.ylim = self.axes.set_xlim((np.min(Y),np.max(Y)))
    ...
    def update_data(self, rho, nu, magnefying):
        self.rho, self.nu, self.magnefying = rho, nu, magnefying
    ...
    def update_figure(self):
        ...
        self.axes.cla()
        self.conduction, self.convection = Math.PlottableAxesBoth(l,r,self.rho, self.nu, self.magnefying)
        self.axes.set_title(LocalVars.PlotTitle)
        self.axes.set_xlabel(LocalVars.PlotXLabel)
        self.axes.set_ylabel(LocalVars.PlotYLabel)
